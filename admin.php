     ...
     <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="admin/list_peminjam_admin.php">Peminjaman</a>
          <a class="dropdown-item" href="admin/list_peminjam_admin.php">Pengembalian</a>
        </div>
      </li>
	  <li class="nav-item">
